...
<body>
	<h1>Löydetyt reseptit:</h1>

	<form action="/hae-nimella">
		<label for="hakusana">Hae nimella:</label> <input type="search"
	...
	<table class="table table_striped">
		...
		<c:forEach items="${reseptit}" var="reseptit">
			<tr>
				...
				<td><a href=""><button type="button">Lisää
	...
	<a href="/uusi-resepti"><button type="button">Lisää uusi resepti</button></a>
